    ...
    return (
        <div className="container projects-container">
            ...
            <div className="tabs-dropdown-wrapper">
                <button
                    className="tabs-dropdown-trigger"
                    onClick={() => setDropdownOpen((o) => !o)}
                >
                    <span>{project.label}</span>
                    <svg
                        className={`tabs-dropdown-chevron${dropdownOpen ? ' tabs-dropdown-chevron--open' : ''}`}
                ...
                {dropdownOpen && (
                    <div className="tabs-dropdown-menu">
                        {PROJECTS.map((p) => (
                            <button
                                key={p.id}
                                className={`tabs-dropdown-item${active === p.id ? ' tabs-dropdown-item--active' : ''}`}
                                onClick={() => selectTab(p.id)}
                            >
                                {p.label}
                                {active === p.id && (
                                    <span className="tabs-dropdown-check">✓</span>
                                )}
                            </button>
                        ))}
                    </div>
